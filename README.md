...
- `llm-box` runs the assistant in a disposable container.
- Outbound access is blocked by default and allowed explicitly through `llm-box`.
- Workspace `HOME` persists across fresh containers for the same workspace.
